# Python Session 8
# Parametric and Nonparametric Tests Lab
...
#%% Before we do the stats, let's talk about the psychology:
...
pruningMode = 2 # This flag determines how we will remove nans. 
...
# So let's do row-wise removal of missing data
# 2) Row wise:
elif pruningMode == 2:
...
#%% 4 Extrastriate cortex: Doing the actual specialized analyses
...
#%% 5 Extrastriate cortex part II: Inferential statistics
...
# Our question now is: Assuming that there is no difference in reality, how
...
if pruningMode == 1:
    ...
    # means) is too large to be comfortably consistent with chance. 
    ...
    t3,p3 = stats.ttestInd(combinedData[0],combinedData[2])
...
#%% 7 Final point: How to do a 2-way ANOVA in Python and make an ANOVA table (and a means plot)
...
filename = 'twoWayAnovaExample.csv'
